...
to-report pWinning [ #self #victim #potentialally]
  let uncertainty [length conflict-memory] of diplomaticrelation [who] of #self [who] of #victim
  let SD-perception-local 0
  carefully [set SD-perception-local(SD-perception / uncertainty)] [ set SD-perception-local 1]
