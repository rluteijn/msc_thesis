...
to interact
  ask diplomaticrelations [
    if (conflict = true)[
      if ( decision-first = "mobilise & fight" AND decision-second = "mobilise & fight" ) [ set conflict false wage-war end1 end2 set type-of-last-conflict "armedconflict"  set decision-first 0 set decision-second 0];; show "1"]
...
to wage-war [ #first #second ];; fight wars etc.
  ...
  if ( [major-power?] of #first = true AND [major-power?] of #second = true) [ show "major power war!!!!!!!!!!"]
...
to structural-change [ #winner #loser #type ] ;; update landscape according to the actions. If a war was fought and won, or bargaining process was done, may field different types of transfers of resources. 
  ...
  let first-alliance-power [MilitaryCapabilities] of #winner + sum [MilitaryCapabilities] of first-alliance
  let second-alliance [alliance-neighbors] of #loser
  let second-alliance-power [MilitaryCapabilities] of #loser + sum [MilitaryCapabilities] of second-alliance
